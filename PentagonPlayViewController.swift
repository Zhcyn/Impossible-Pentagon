//
//  PentagonPlayViewController.swift
//  Impossible Pentagon
//
...
class PentagonPlayViewController: UIViewController {
    ...
    func setUpSquare() {
        if squareFace == 0 {
            imgOutlet.image = #imageLiteral(resourceName: "pentagonYellow")
        } else if squareFace == 1 {
            imgOutlet.image = #imageLiteral(resourceName: "pentagonRed")
        } else if squareFace == 2 {
            imgOutlet.image = #imageLiteral(resourceName: "pentagonBlue")
        } else if squareFace == 3 {
            imgOutlet.image = #imageLiteral(resourceName: "pentagonGreen")
        } else if squareFace == 4 {
            imgOutlet.image = #imageLiteral(resourceName: "pentagonPilple")
        }
    }
